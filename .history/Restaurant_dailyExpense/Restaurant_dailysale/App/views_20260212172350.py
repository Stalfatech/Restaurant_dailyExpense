...
def add_expense(request):
    ...
    if form.is_valid():
        ...
        # Assign branch: if Admin selects one, use it; otherwise use user's branch
        user_type = request.session.get('usertype')
        if user_type == 0: # Admin
            ...
            expense.branch = user.branch  # Manager
    ...
    return render(request, 'expenses/expense_form.html', {'form': form, 'user_type': request.session.get('usertype') })
