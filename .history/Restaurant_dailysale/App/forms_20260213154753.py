...
class ExpenseForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'quantity', 'purchase_type', 'amount','amount_text', 'invoice', 'description', 'branch','status'
        ]
...
'amount': forms.TextInput(attrs={'id': 'amountField', 'class': 'form-control'}),
'amount_text': forms.TextInput(attrs={'id': 'amountTextField', 'class': 'form-control', 'readonly': True}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['amount_text'].required = False
