...
class ExpenseForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'quantity', 'purchase_type', 'amount', 'description', 'branch','status'
        ]
...
'amount': forms.NumberInput(attrs={'id': 'amountField', 'class': 'form-control'}),
    ...
    # If editing and no new file uploaded, keep existing
...
class DailySaleForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'pos_type': forms.Select(attrs={'class': 'form-control'}),
        }
    def __init__(self, *args, **kwargs):
            user = kwargs.pop('user', None)
            super().__init__(*args, **kwargs)
