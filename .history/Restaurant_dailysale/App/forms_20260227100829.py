...
class CommunicationSettingsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'whatsapp_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '+1234567890 or 1234567890'}),
        }

    def clean_whatsapp_number(self):
        """
        Validates that the number is 10 digits or a valid international format.
        Allows: +919876543210, 9876543210, +1 (555) 123-4567
        """
        ...
        # Matches international (+123...) and 10 digit (1234567890)
        phone_pattern = r'^\+?\d{7,15}$'

        if not re.match(phone_pattern, cleaned_number):
            raise ValidationError(
                "Invalid phone number format. Please use 10 digits or international format (e.g., +1234567890)."
            )
