...
urlpatterns = [
  ...
  path('extract-invoice-amount/', views.extract_invoice_amount_ajax, name='extract_invoice_amount'),
  path(extract_invoice_amount_ajax, views.extract_invoice_amount_ajax, name='extract_invoice_amount_ajax'),
