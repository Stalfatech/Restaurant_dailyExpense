...
path('send-adminstaff-daily-salary-report/', views.send_adminstaff_daily_salary_report, name='send_adminstaff_daily_salary_report'),


path('send-adminstaff-monthly-salary-report/', views.send_adminstaff_monthly_salary_report, name='send_adminstaff_monthly_salary_report'),


path(
    "send-manager-monthly-report/",
    views.send_manager_monthly_report,
    name="send_manager_monthly_report"
),
path("send-daily-salary-report/", views.send_staff_daily_salary_report, name="send_daily_salary_report"),
