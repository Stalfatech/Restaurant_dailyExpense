...
import tempfile, os
from .utils.google_vision_parser import extract_amount_from_invoice
from django.http import JsonResponse
import tempfile, os
from .utils.invoice_parser import extract_amount_from_invoice, extract_numeric_from_text  # we'll add extract_numeric_from_text
