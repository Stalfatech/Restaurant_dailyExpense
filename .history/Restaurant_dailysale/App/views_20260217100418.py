...
from .forms import DailySaleItemFormSet, LoginForm,ForgotPasswordForm,ResetPasswordForm
from django.conf import settings
...
def add_daily_sale(request):
    ...
    form = DailySaleForm(request.POST or None)
    item_formset = DailySaleItemFormSet(request.POST or None)
    delivery_formset = DeliveryFormSet(request.POST or None)
...
def edit_daily_sale(request, pk):
    ...
    form = DailySaleForm(request.POST or None, instance=sale)
    item_formset = DailySaleItemFormSet(request.POST or None, instance=sale)
    delivery_formset = DeliveryFormSet(request.POST or None, instance=sale)
