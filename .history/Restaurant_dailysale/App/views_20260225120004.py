...
from datetime import datetime
from .models import DeliverySale
from .utils import generate_pdf, send_email, send_whatsapp
...
def send_report(request, report_type):
    ...
    # Generate PDF using same layout
    ...
    if send_via == "email":
        ...
        return redirect('delivery_report')

    elif send_via == "whatsapp":
        message = f"Delivery Total: {grand_total}"
        return send_whatsapp(request.POST.get("whatsapp"), message)