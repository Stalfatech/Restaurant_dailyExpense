...
@login_required
def send_daily_salary_report(request):
    ...
    if request.method == "POST":
        ...
        if send_via == "email":
            ...
            messages.success(request, "Daily salary report sent via Email.")
    ...
    return render(request, "reports/export_page.html", {
        ...
        "action_url": reverse("send_daily_salary_report")
    })
