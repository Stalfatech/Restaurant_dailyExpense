...
def export_report_page(request, report_type):
    ...
    elif report_type == "staff_daily_salary_manager":
        action_url = reverse('send_staff_daily_salary_report')
    elif report_type == "staff_monthly_salary_manager":
        action_url = reverse('send_staff_monthly_salary_report')
