...
def add_salary(request):
    ...
    if request.method == "POST":
        ...
        notify(request, f"Salary Added Successfully. Final Balance: {balance_salary}")
        return redirect('salary_list')
...
def edit_salary(request, pk):
    ...
    if request.method == "POST":
        ...
        notify(request, "Salary updated successfully")
        return redirect('salary_list')
...
def delete_salary(request, pk):
    ...
    notify(request, "Salary deleted successfully.")
    return redirect('salary_list')
...
def send_staff_daily_salary_report(request):
    ...
    if request.method == "POST":
        ...
        if send_via == "email":
            ...
            messages.info(request, "Daily Staff salary report sent via Email.")
            notify(request, "Daily salary report sent via Email ✅")
